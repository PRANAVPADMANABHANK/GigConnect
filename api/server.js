...
//middleware
app.use(cors({ origin: ["http://localhost:5173", "gigconnect.stepups.live"], credentials: true })); //"origin" => represents we are connecting frontend to backend using cors library. "credential" => represents passing cookie from frontend to backend.
