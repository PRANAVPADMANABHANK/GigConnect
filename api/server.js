...
//middleware
app.use(cors({ origin: ["http://localhost:5173", "http://gigconnect.stepups.live"], credentials: true })); // ["https://localhost:5173", "https://gigconnect.stepups.live"]  "origin" => represents we are connecting frontend to backend using cors library. "credential" => represents passing cookie from frontend to backend.
...
const io = new SocketServer(httpServer, {
  pingTimeout:60000,
  cors: {
    origin: ["http://localhost:5173", "http://gigconnect.stepups.live"],
  },
});
